  ...
  try {
    ...
    const [result] = await pool.query(
      `INSERT INTO travel_document_vault
       (user_id, guest_id, profile_name, relation, document_type, document_name, document_number, issue_date, expiry_date, notes, file_name, file_type, file_size, file_data, is_offline_ready, is_family_document)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [
        owner.userId,
        owner.guestId,
